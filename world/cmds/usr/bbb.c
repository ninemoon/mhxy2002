...
int main(object me, string arg)
{
      ...
      //if( me->is_fighting() ) return notify_fail("你正在战斗，无暇变身。\n");
      //if( me->is_busy() || me->query_temp("pending/exercising")) return notify_fail("你正忙着呢，没工夫变身。\n");
   ...
   mana=me->query("mana");
		//if (me->query("combat_exp") < 30000)   return notify_fail("你的道行还不够。\n");
		//if (spells<25) return notify_fail("你的法术不够。\n");
        //if (mana<150) return notify_fail("你的法力不足。\n");
